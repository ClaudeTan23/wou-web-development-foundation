        ...
        <div class="header_section">
            <div class="container-fluid">
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="logo"><a href="/" style="font-size: 24px; font-weight: 600; color: #202020;">ABC Jobs
                            Pte Ltd</a></div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td bgcolor="#ffffff" align="left"
                                                            ...
                                                            <p class="headingMobile"
                                                                ...
                                                                Verify your e-mail to complete the registration</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="20"></td>
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#ffffff" align="left"
                                                            ...
                                                            <p
                                                                style="margin:0;color:#585858;font-size:14px;font-weight:400;line-height:170%;">
                                                                Please confirm that <b>${email}</b> is your e-mail address
                                                                We have send a verification link to your email. Please click the verify button on the mail we 
