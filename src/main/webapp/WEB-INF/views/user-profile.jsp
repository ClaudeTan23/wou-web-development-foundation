                                        ...
                                        <svg id="graph" width="60" height="60" style="position: absolute; top: -5px">
                                            ...
                                            <defs>
                                                <pattern id="image" x="0%" y="0%" height="100%" width="100%" viewBox="0 0 512 512">
                                                    <image x="0%" y="0%" width="512" height="512" xlink:href="/images/${Auth.image}"></image>
                                                </pattern>
                                            </defs>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-column align-items-center text-center">
                                        <img src="/images/${user.image}" id="profileIcon" alt="" class="rounded-circle" style="width: 150px; height: 150px;">
                                    <div class="mt-3">
